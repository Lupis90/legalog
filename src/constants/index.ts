...
export const BASE_POINTS_4 = { 1: 6, 2: 4, 3: 3, 4: 2 } as const;
export const BASE_POINTS_3 = { 1: 6, 2: 4, 3: 2 } as const;
export const BASE_POINTS_5 = { 1: 7, 2: 5, 3: 3, 4: 2, 5: 1 } as const;
